...
- 1941: The Bombe (UK)
	...
	**Alan Turing**, **Gordon Welchman** and **Harold 'Doc' Keen** developed **the Bombe**, an electromechanical machine, to help decrypt messages protected by the German **ENIGMA cipher**. Its use helped the Allies read encrypted communications during the war.
...
- 1946: ENIAC's Programmers

    **Jean Bartik**, **Betty Holberton**, **Kathleen Antonelli**, **Marlyn Meltzer**, **Frances Spence** and **Ruth Teitelbaum** programmed ENIAC. They worked out how to turn mathematical procedures into machine instructions. Their contributions to programming were often overlooked because the work was often described as simply 'operating the machine'.

	<captioned>

	![](./_assets/1940s/eniac-programmers.jpg)
...
- 1943: Colossus (UK)
	...
	**Tommy Flowers** built **Colossus** to help break the **Lorenz ciphers** used by the German Army. Its vacuum-tube circuits and continuous punched paper tape reduced the work of breaking messages from weeks to hours. The machine could be reprogrammed in a limited way, using switches and plugboards, but was not a general-purpose computer.
...
- 1945: Von Neumann Architecture
    ...
    **John von Neumann**, after discussion with **John Mauchly** and **J. Presper Eckert** and others (the designers of ENIAC), described a design architecture for an electronic, stored-program, digital computer with:

    - A **control unit** to sequence operations
    - An **arithmetic & logic unit** (ALU)
    - **Memory** to store data and instructions
    - **Storage** for input and output data
    - Input and output **transfer** mechanisms
...
- 1949: EDSAC (UK)
	...
	**EDSAC** at Cambridge helped establish practical **stored-program computing**. EDSAC was the first practical stored-program computer to enter **regular service**.
...
- 1949: CSIRAC (AUS)
	...
	Australia's **CSIRAC** was completed in Sydney for the Council of Scientific and Industrial Research. It ran its first test program (multiplication of numbers) in November 1949. Its memory and processor ran at **1kHz**.
