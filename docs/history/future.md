...
I'm going to miss my human programmers, hand-crafting my beautiful code...
...
- Near term: Hybrid quantum computing
    ...
    ![](../_assets/future/quantum.jpeg)

    Quantum processor

    ![](../_assets/future/quantum.webp)
...
- 2030s and beyond: Neuromorphic circuitry
    ...
    ![](../_assets/future/neuromorphic.jpg)
...
- 2030s and beyond: Optical processors
    ...
    ![](../_assets/future/optical-processor.jpg)
...
- 2030s and beyond: Biological data storage
    ...
    ![](../_assets/future/dna-storage.jpg)
...
- Near term: Post-quantum cryptography
    ...
    Organisations are beginning to replace vulnerable public-key algorithms with standardised post-quantum methods. Migration will take years because certificates, devices and archived encrypted data all need to be updated before large fault-tolerant quantum computers exist.

    <captioned>

    ![](../_assets/future/post-quantum.jpg)

    Post-quantum cryptography

    </captioned>

- Near term: Natural-language programming tools

    AI tools will translate natural-language requests into code, tests and configuration. They can lower the barrier to experimentation, but generated software still needs human review for security, correctness, performance and maintenance.

    <captioned>

    ![](../_assets/future/natural-language-code.jpg)
