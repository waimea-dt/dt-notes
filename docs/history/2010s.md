...
- 2012: Titan Supercomputer
	...
	The **Titan** supercomputer combined conventional **AMD processors** with more than **261,000 NVIDIA GPU accelerator cores**. It achieved **17.59 quadrillion floating point operations per second (PFLOPS)**, showing how graphics processors could massively accelerate scientific calculations.
