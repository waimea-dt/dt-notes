...
- 1964: BASIC Programming Language
	...
	**John Kemeny** and **Thomas Kurtz** developed **BASIC** to make **programming easier for student**s. It became the standard language used in school and was installed on most personal computers in the 1980s, introducing generations of people to code.
