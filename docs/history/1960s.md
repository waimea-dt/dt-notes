...
- 1960: First Computers in New Zealand
    ...
    A year later, an **IBM 650** computer was installed at the **Treasury** to automate the payroll processing for roughly 34,000 New Zealand public servants.

    Early academic computing arrived when **IBM 1620** computers were installed at the **University of Canterbury** (1962) and the **University of Auckland** (1963)

	<captioned>

	![](./_assets/1960s/nz-cartoon.jpg)

	Cartoon about the computers
    ...
    <video controls>
      <source src="https://teara.govt.nz/sites/default/files/33025-enz-h.mp4" type="video/mp4">
      No video support
    </video>

    Treasury computer newsreel
...
- 1964: Cray CDC 6600
	...
	**Seymour Cray**'s **CDC 6600** became a commercially successful **supercomputer**. It cost US$2,370,000 (equivalent to US$25M today) and had a **60-bit processor** running at **10MHz**, memory up to **982kB** and could perform roughly **3 million floating point operations per second (MFLOPS)**
...
- 1969: Margaret Hamilton and Apollo Software
	...
	**Margaret Hamilton** led the team at MIT that developed the **Apollo flight software** for the Apollo Guidance Computer. The software was programmed into the computer by 'weaving' it into magnetic core memory.
	...
	Margaret Hamilton with printouts of the Apollo code
