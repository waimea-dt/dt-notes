...
- 1980: Seagate ST-506 Hard Disk Drive
	...
	The first consumer-grade hard disk drive for personal computers was the Seagate ST-506, released in 1980. It was a 5.25 inch unit with a capacity 5MB, using a stack of spinning metal platters. It cost US$1,500 at launch.
...
- 1981: ZX-81
	...
	The ZX81 improved upon the ZX80, using a 3.25MHz Z80 CPU, 1kB of RAM and 8kB of ROM. It launched in the UK at £49.95 as a kit or £69.95 ready-built and sold in large numbers, helping turn home computers into a British mass-market hobby.
...
- 1981: IBM PC 5150
	...
	IBM introduced its first personal computer, code-named Acorn, with a 4.77MHz Intel 8088 processor, 16kB of RAM, floppy-disk storage and Microsoft's MS-DOS. The IBM PC 5150 helped popularise the term 'PC' and created a widely copied hardware standard.
...
- 1982: Commodore 64
	...
	The Commodore 64 used a 1MHz 6510 CPU, 64kB of RAM, a colour graphics chip and the SID programmable sound chip. It became the best-selling model of personal-computer; its colour graphics, sound and large software library made it popular for both games and programming.
...
- 1982: Epson HX-20
	...
	The Epson HX-20 was an early battery-powered portable computer, with a small screen, keyboard and built-in printer and cassette storage. It showed the direction portable computing would take.
...
- 1983: Domain Name System
	...
	The Domain Name System, or DNS, was introduced to map memorable names such as `example.com` to numerical IP addresses. It replaced a single manually maintained hosts file and made the growing Internet easier to use and administer.

- 1984: Internet reaches 1,000 hosts

	The number of computers recorded in the Internet's host tables passed roughly 1,000. The count referred to connected hosts, not people, and showed that the network was growing beyond its original research community.
...
- 1986: NSFNET expands academic networking

	The US National Science Foundation created NSFNET to connect universities and research centres. Its 56kbit/s backbone was upgraded to 1.5Mbit/s in 1988, and the network helped move Internet access beyond the original ARPANET community.

- 1987: Internet reaches 10,000 hosts

	The number of known Internet hosts passed roughly 10,000 as universities, research organisations and emerging network providers joined the interconnected network.
